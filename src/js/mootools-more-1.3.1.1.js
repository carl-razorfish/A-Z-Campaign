...
// Load this file's selection again by visiting: http://mootools.net/more/bb3dbd793057f7096c7c05ef30e10a48 
// Or build this file again with packager using: packager build More/Fx.Accordion More/Fx.Scroll
/*
---
copyrights:
...
}}}.bind(this));return c?this.start(h):this.set(h);}});(function(){Fx.Scroll=new Class({Extends:Fx,options:{offset:{x:0,y:0},wheelStops:true},initialize:function(c,b){this.element=this.subject=document.id(c);
...
}return this;}});function a(b){return(/^(?:body|html)$/i).test(b.tagName);}}).call(this);