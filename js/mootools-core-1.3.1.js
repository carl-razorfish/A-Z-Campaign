...
web build:
 - http://mootools.net/core/80718caf286889b90064f09c199cd085

packager build:
 - packager build Core/Object Core/Element.Dimensions Core/Fx.Tween Core/Fx.Transitions Core/DOMReady
...
});var c=Date.now();String.extend("uniqueID",function(){return(c++).toString(36);});}).call(this);(function(){var a=Object.prototype.hasOwnProperty;Object.extend({subset:function(d,g){var f={};
...
break;default:f=g+"="+encodeURIComponent(h);}if(h!=null){d.push(f);}});return d.join("&");}});})();Array.implement({invoke:function(a){var b=Array.slice(arguments,1);
