...
Function.prototype.bind=function(b){var a=this;return function(){return a.apply(b,arguments)}};Function.prototype.pass=function(b,c){var a=this;if(b!=null){b=Array.from(b)}return function(){return a.apply(c,b||arguments)}};var RIA={};Log={info:function(a){if(window.console&&console.log){console.log(a)}},error:function(a){if(a.error instanceof TypeError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : TypeError; the type of a variable is not as expected : "+(a.error.message||a.error))}else{if(a.error instanceof RangeError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : RangeError; numeric variable has exceeded its allowed range : "+(a.error.message||a.error))}else{if(a.error instanceof SyntaxError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : SyntaxError; syntax error occurred while parsing : "+(a.error.message||a.error))}else{if(a.error instanceof ReferenceError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : ReferenceError; invalid reference used : "+(a.error.message||a.error))}else{this.info("JS ERROR : "+(a.method||"Unknown method")+" : Unidentified Error Type : "+(a.error.message||a.error))}}}}}};RIA.AZCampaign={options:{keyCodes:{"65":"a","66":"b","67":"c","68":"d","69":"e","70":"f","71":"g","72":"h","73":"i","74":"j","75":"k","76":"l","77":"m","78":"n","79":"o","80":"p","81":"q","82":"r","83":"s","84":"t","85":"u","86":"v","87":"w","88":"x","89":"y","90":"z"}},init:function(a){if(a){Object.merge(this.options,a)}this.articles=document.getElements("article");this.navigation=document.getElementById("navigation");this.storeArticleData();this.collectArticleTags();this.addEventListeners();this.createNumericKeyCodes();this.scrollFX=new Fx.Scroll(window,{duration:1000,transition:"sine:out",link:"cancel"});if(this.options.filter&&this.options.filter!=""){this.filter(this.options.filter)}},createNumericKeyCodes:function(){var a=49;Object.each(this.options.categories,function(c,b){this.options.keyCodes[""+a]=b;a++},this);a=null;Log.info(this.options.keyCodes)},storeArticleData:function(){this.articles.each(function(a){a.ria={id:a.getAttribute("id"),w:parseFloat(a.getStyle("width")),h:parseFloat(a.getStyle("height")),offsetTop:a.offsetTop,marginBottom:a.getStyle("marginBottom"),paddingTop:a.getStyle("paddingTop"),paddingBottom:a.getStyle("paddingBottom"),filterFx:new Fx.Morph(a,{duration:"long",transition:Fx.Transitions.Sine.easeOut})}},this)},filterFx:function(b,a,c){if(a&&c){b.ria.filterFx.set({height:b.ria.h,opacity:1,marginBottom:b.ria.marginBottom,paddingTop:b.ria.paddingTop,paddingBottom:b.ria.paddingBottom})}else{b.ria.filterFx.start({height:(a?b.ria.h:0),opacity:(a?1:0),marginBottom:(a?b.ria.marginBottom:0),paddingTop:(a?b.ria.paddingTop:0),paddingBottom:(a?b.ria.paddingBottom:0)})}},collectArticleTags:function(){var b=new Array(),a;this.articles.each(function(f){a=f.getAttribute("id");b=f.getAttribute("data-tags").split("|");for(var d=0,c=b.length;d<c;d++){var e=b[d];if(this.options.categories[e]&&this.options.categories[e].indexOf(a)===-1){this.options.categories[e].push(a)}}},this);i=l=a=b=null},addEventListeners:function(){this.navigation.addEventListener("click",this.selectEvent.bind(this),false);window.addEventListener("keydown",function(a){if(!a.ctrlKey&&!a.shiftKey&&!a.altKey){this.filter(this.options.keyCodes[a.keyCode])}}.bind(this),false)},selectEvent:function(a){if(a.target.getAttribute("data-category")){a.preventDefault();this.filter(a.target.getAttribute("data-category"))}},filter:function(a){if(this.options.categories[a]){this.filterByCategory(a)}else{this.goToAlphabet(a)}},filterByCategory:function(d){var c;if(this.options.categories[d]){this.scrollFX.toTop();for(var b=0,a=this.articles.length;b<a;b++){c=this.articles[b].ria.id;if(this.options.categories[d].indexOf(c)===-1){this.filterFx(this.articles[b],false)}else{this.filterFx(this.articles[b],true)}}}b=a=c=null},filterInAll:function(){for(var b=0,a=this.articles.length;b<a;b++){this.filterFx(this.articles[b],true,true)}article=b=a=null},goToAlphabet:function(b){var a=document.getElementById(b);if(a){this.filterInAll();this.scrollFX.start(0,a.ria.offsetTop)}b=a=null}};RIA.UI={init:function(){this.shell=document.id("shell");this.nav=document.getElementById("navigation");this.navOffsetTop=this.nav.offsetTop;this.addEventListeners()},addEventListeners:function(){window.addEventListener("scroll",this.windowScroll.bind(this),false);document.body.addEventListener("touchstart",this.bodyIOSTouchStart.bind(this),false)},windowScroll:function(a){this.nav.style.top=this.navOffsetTop+document.body.scrollTop+"px"},bodyIOSTouchStart:function(a){this.originalPos={x:a.targetTouches[0].clientX,y:a.targetTouches[0].clientY};this.startPos={x:a.targetTouches[0].clientX,y:a.targetTouches[0].clientY};document.body.addEventListener("touchmove",this.bodyIOSTouchMove.bind(this),false)},bodyIOSTouchMove:function(b){b.preventDefault();var a;Log.info("this.shell.offsetTop: "+this.shell.offsetTop);this.currentPos={x:b.targetTouches[0].clientX,y:b.targetTouches[0].clientY};this.newPos={x:this.originalPos.x-this.currentPos.x,y:this.originalPos.y-this.currentPos.y};a=document.body.style.webkitTransform;a=(a!="")?a.substring(11):"0";a=a.replace(")px","");a=parseFloat(a);document.body.style.webkitTransition="all 1s ease-in-out";document.body.style.webkitTransform="translateY("+(this.newPos.y-a)+"px)";this.originalPos=this.currentPos}};
