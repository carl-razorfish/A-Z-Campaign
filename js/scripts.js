...
var RIA={};RIA.Util={getViewport:function(){return{h:(window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight||0),scrollTop:(window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0)}}};Log={info:function(a){if(window.console&&console.log){console.log(a)}},error:function(a){if(a.error instanceof TypeError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : TypeError; the type of a variable is not as expected : "+(a.error.message||a.error))}else{if(a.error instanceof RangeError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : RangeError; numeric variable has exceeded its allowed range : "+(a.error.message||a.error))}else{if(a.error instanceof SyntaxError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : SyntaxError; syntax error occurred while parsing : "+(a.error.message||a.error))}else{if(a.error instanceof ReferenceError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : ReferenceError; invalid reference used : "+(a.error.message||a.error))}else{this.info("JS ERROR : "+(a.method||"Unknown method")+" : Unidentified Error Type : "+(a.error.message||a.error))}}}}}};RIA.AZCampaign=new Class({Implements:[Options],options:{filter:null,scrollMultiplier:100,keyCodes:{"65":"a","66":"b","67":"c","68":"d","69":"e","70":"f","71":"g","72":"h","73":"i","74":"j","75":"k","76":"l","77":"m","78":"n","79":"o","80":"p","81":"q","82":"r","83":"s","84":"t","85":"u","86":"v","87":"w","88":"x","89":"y","90":"z"}},initialize:function(a){try{this.setOptions(a);this.articles=document.getElements("article");this.navigation=document.id("navigation");this.navOffsetTop=this.navigation.offsetTop;Log.info(this.navOffsetTop);this.navAlpha=document.getElements("#navigation #alphabet a");this.navCategories=document.getElements("#navigation #categories a");this.storeArticleData();this.setInitialImageState();this.addEventListeners();this.addScrollGetContentListener();this.createNumericKeyCodes();this.scrollFx=new Fx.Scroll(window,{duration:1000,transition:"sine:in:out",link:"cancel",onStart:function(c){Log.info("scrollFx onStart");this.removeScrollGetContentListener()}.bind(this),onComplete:function(c){this.scrollFx.options.duration=1000;Log.info("Scroll complete");this.getContentWithinViewport();this.addScrollGetContentListener()}.bind(this)});this.navFX=new Fx.Tween(this.navigation,{fps:100,duration:700,transition:"sine:out",link:"chain"});Log.info("current category : "+this.options.category);this.getContentWithinViewport()}catch(b){Log.info("RIA.AZCampaign : init() : Error : "+b.message)}},setInitialImageState:function(){var a;this.articles.each(function(b){a=b.getElement(".content-image img");a.set({src:a.get("data-loading-src"),width:a.get("data-loading-width"),height:a.get("data-loading-height"),"class":a.get("data-loading-class")})},this);a=null},showContent:function(b){b.ria.state="loaded";var a=b.getElement(".content-image img");a.set({src:a.ria.original.src,width:a.ria.original.w,height:a.ria.original.h});a.removeClass("loading");a=null},hideContent:function(b){b.ria.state="unloaded";var a=b.getElement(".content-image img");a.set({src:a.get("data-loading-src"),width:a.get("data-loading-width"),height:a.get("data-loading-height")});a.addClass("loading");a=null},createNumericKeyCodes:function(){var a=49;Object.each(this.options.categories,function(c,b){this.options.keyCodes[""+a]=b;a++},this);a=null},storeArticleData:function(){var a;this.articles.each(function(b){a=b.getElement("img");b.ria={state:"unloaded",required:true,w:Math.floor(parseFloat(b.getStyle("width"))),h:Math.floor(parseFloat(b.getStyle("height"))),marginBottom:b.getStyle("marginBottom"),paddingTop:b.getStyle("paddingTop"),paddingBottom:b.getStyle("paddingBottom"),filterFx:new Fx.Morph(b,{duration:"long",link:"cancel",transition:"sine:in:out"})};a.ria={original:{src:a.get("src"),w:a.get("width"),h:a.get("height")}};if(b.hasClass("inactive")){b.ria.h=(b.ria.h+Math.floor(parseFloat(b.getElement("header").getStyle("height")))+Math.floor(parseFloat(b.getElement("nav").getStyle("height"))));b.setStyle("height",0)}},this);a=null},filterFx:function(b,a,c){if(a&&c){b.ria.filterFx.set({height:b.ria.h,opacity:1,marginBottom:b.ria.marginBottom,paddingTop:b.ria.paddingTop,paddingBottom:b.ria.paddingBottom})}else{this.hideContent(b);b.ria.filterFx.start({height:(a?b.ria.h:0),opacity:(a?1:0),marginBottom:(a?b.ria.marginBottom:0),paddingTop:(a?b.ria.paddingTop:0),paddingBottom:(a?b.ria.paddingBottom:0)})}},addEventListeners:function(){this.navigation.addEventListener("click",this.selectEvent.bind(this));window.addEventListener("keyup",this.keyboardEvent.bind(this),false);window.addEvent("resize",this.getContentWithinViewport.bind(this));window.addEvent("scroll",this.setNavPosition.bind(this))},addScrollGetContentListener:function(){this.getContentBind=this.getContentWithinViewport.bind(this);window.addEvent("scroll",this.getContentBind)},removeScrollGetContentListener:function(){window.removeEvent("scroll",this.getContentBind)},keyboardEvent:function(a){Log.info(a);if(!a.ctrlKey&&!a.shiftKey&&!a.altKey&&!a.metaKey){this.filter(this.options.keyCodes[a.keyCode])}},selectEvent:function(a){if(a.target.getAttribute("data-category")){a.preventDefault();this.filter(a.target.getAttribute("data-category"))}},filter:function(a){if(this.options.categories[a]){this.filterByCategory(a)}else{this.goToAlphabet(a)}},filterByCategory:function(a){this.setAlphaNavState();if(this.options.categories[a]){this.options.category=a;this.setCategoryNavState(a);this.articles.each(function(c,b){c.removeClass("active").removeClass("inactive");if(this.options.categories[a].indexOf(c.get("id"))===-1){c.ria.required=false;this.filterFx(c,false,false)}else{c.ria.required=true;Log.info(c.get("id")+" : state : "+c.ria.state+" : required : "+c.ria.required);this.filterFx(c,true,false);document.id("nav-alpha-"+c.get("id")).addClass("active")}},this);this.scrollFx.toTop()}},filterInAll:function(){this.articles.each(function(a){a.removeClass("active").removeClass("inactive");this.filterFx(a,true,true)},this)},setCategoryNavState:function(a){this.navCategories.each(function(b){b.removeClass("active");b.removeClass("inactive");if(b.id=="nav-category-"+a){b.addClass("active")}},this)},setAlphaNavState:function(a){this.navAlpha.each(function(b){if(a=="all"){b.removeClass("inactive");b.addClass("active")}else{if(b.id=="nav-alpha-"+a){b.removeClass("inactive");b.addClass("active")}else{b.removeClass("active");b.addClass("inactive")}}},this)},goToAlphabet:function(c){var a=RIA.Util.getViewport(),b=document.id(c);if(b){if(this.options.categories[this.options.category]&&this.options.categories[this.options.category].indexOf(c)===-1){this.filterInAll();this.setCategoryNavState();this.setAlphaNavState("all")}if(b.getPosition().y<a.scrollTop){this.scrollFx.options.duration+=Math.floor(Math.PI*((a.scrollTop-b.getPosition().y)/10))}else{this.scrollFx.options.duration+=Math.floor(Math.PI*((b.getPosition().y-a.scrollTop)/10))}this.scrollFx.toElement(c,"y")}a=b=null},getContentWithinViewport:function(c){var a=RIA.Util.getViewport(),b;Log.info("getContentWithinViewport()");this.articles.each(function(d){b=d.getPosition();if((b.y>=a.scrollTop&&b.y<=(a.scrollTop+a.h))||(((b.y+d.ria.h)>=a.scrollTop)&&(b.y+d.ria.h)<=(a.scrollTop+a.h))){if(d.ria.state!="loaded"){this.showContent(d)}}else{this.hideContent(d)}},this);a=b=null},setNavPosition:function(){if(!Browser.Platform.ios){if(this.navigation&&this.navOffsetTop){this.navigation.style.top=this.navOffsetTop+document.body.scrollTop+"px"}}else{if(this.navFX&&this.navOffsetTop){this.navFX.start("top",(this.navOffsetTop+document.body.scrollTop))}}}});
