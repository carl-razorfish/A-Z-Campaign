...
web build:
 - http://mootools.net/core/32594624b2ba3e2a7df1e89752b35fdb

packager build:
 - packager build Core/Element.Event Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/DOMReady
...
}).call(this);(function(){var c=document.html;Element.Properties.styles={set:function(f){this.setStyles(f);}};var e=(c.style.opacity!=null);var d=/alpha\(opacity=([\d.]+)\)/i;
...
var RIA={};RIA.Util={getViewport:function(){return{w:(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth||0),h:(window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight||0),scrollTop:(window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0)}}};Log={info:function(a){if(window.console&&console.log){console.log(a)}},error:function(a){if(a.error instanceof TypeError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : TypeError; the type of a variable is not as expected : "+(a.error.message||a.error))}else{if(a.error instanceof RangeError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : RangeError; numeric variable has exceeded its allowed range : "+(a.error.message||a.error))}else{if(a.error instanceof SyntaxError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : SyntaxError; syntax error occurred while parsing : "+(a.error.message||a.error))}else{if(a.error instanceof ReferenceError){this.info("JS ERROR : "+(a.method||"Unknown method")+" : ReferenceError; invalid reference used : "+(a.error.message||a.error))}else{this.info("JS ERROR : "+(a.method||"Unknown method")+" : Unidentified Error Type : "+(a.error.message||a.error))}}}}}};RIA.AZCampaign=new Class({Implements:[Options],options:{alpha:null,categories:null,category:null,filter:null,keyCodes:{"65":"a","66":"b","67":"c","68":"d","69":"e","70":"f","71":"g","72":"h","73":"i","74":"j","75":"k","76":"l","77":"m","78":"n","79":"o","80":"p","81":"q","82":"r","83":"s","84":"t","85":"u","86":"v","87":"w","88":"x","89":"y","90":"z"},alphabet:["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"]},initialize:function(a){try{this.setOptions(a);document.getElement("body").addClass("js");this.articles=document.getElements("article");this.navigation=document.getElements("#navigation, ul.categories");this.navigationPanel=document.id("navigation");this.shell=document.id("shell");this.setNavigationPanelPosition();this.navOffsetTop=this.navigationPanel.offsetTop;this.navArticles=document.getElements("#navigation #alphabet a");this.navCategories=document.getElements("#navigation #categories a, article .categories a");this.storeArticleData();this.scrollFx=new Fx.Scroll(window,{offset:{x:0,y:-100},duration:1000,transition:"sine:in:out",link:"cancel",onStart:function(c){this.removeScrollGetContentListener()}.bind(this),onComplete:function(c){this.scrollFx.options.duration=1000;this.getContentWithinViewport();this.addScrollGetContentListener()}.bind(this),onCancel:function(c){Log.info("Cancelling scroll");this.scrollFx.options.duration=1000;this.getContentWithinViewport();this.addScrollGetContentListener()}.bind(this)});this.navFX=new Fx.Tween(this.navigation,{fps:50,duration:1000,transition:"sine:in:out",link:"cancel"});this.getContentWithinViewport();document.id("content").addEvents({click:function(d){if(d.target.hasClass("info")){d.preventDefault();var c=d.target.getParent("article");if(c.hasClass("questions")){c.removeClass("questions")}else{c.addClass("questions")}}}.bind(this)});if(!this.options.alpha||this.options.alpha==""){this.addEventListeners();this.addScrollGetContentListener()}else{window.addEvent("resize",this.windowResizeEvent.bind(this))}}catch(b){Log.error({method:"RIA.AZCampaign : initialize() : Error : ",error:b})}},setNavigationPanelPosition:function(){var a=RIA.Util.getViewport().w,b=this.shell.getWidth();if(a>b){this.navigationPanelOffsetLeft=((a-b)/2);this.navigationPanel.setStyle("left",this.navigationPanelOffsetLeft+"px")}},handleContent:function(c,f){var a=c.getElement(".container"),e=c.getElement("nav"),d=c.getElement(".content-image"),b;b=d.getElement("img");if(f===true){if(!b){d.adopt(b=new Element("img",{src:d.get("data-main-src"),width:d.get("data-main-width"),height:d.get("data-main-height"),alt:d.get("data-alt")}))}e.setStyle("visibility","visible");b.set("src",d.get("data-main-src"));b.set("width",d.get("data-main-width"));b.set("height",d.get("data-main-height"));if(!Browser.Platform.ios){a.tween("opacity",1)}else{a.setStyle("opacity",1)}if(!c.getElement("iframe")){this.createFacebookLikeButton(c)}}else{a.setStyle("opacity",0);e.setStyle("visibility","hidden");if(b){b.set("src","data:image/gif;base64,R0lGODlhAQABAPAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==")}}a=e=b=d=null},storeArticleData:function(){this.articles.each(function(a){a.ria={w:Math.floor(parseFloat(a.getStyle("width"))),h:Math.floor(parseFloat(a.getStyle("height"))),marginBottom:a.getStyle("marginBottom"),paddingTop:a.getStyle("paddingTop"),paddingBottom:a.getStyle("paddingBottom"),filterFx:new Fx.Morph(a,{duration:1000,link:"cancel",transition:"sine:in:out"}),accordionFx:new Fx.Accordion($$(".question"),$$(".answer"),{display:-1,alwaysHide:true,opacity:false,duration:500})};if(a.hasClass("inactive")){a.ria.h=(a.ria.h+Math.floor(parseFloat(a.getElement("header").getStyle("height")))+Math.floor(parseFloat(a.getElement("nav").getStyle("height"))));a.setStyle("height",0)}},this)},filterFx:function(b,a,c){if(a&&c){b.ria.filterFx.set({height:b.ria.h,opacity:1,marginBottom:b.ria.marginBottom,paddingTop:b.ria.paddingTop,paddingBottom:b.ria.paddingBottom})}else{b.ria.filterFx.start({height:(a?b.ria.h:0),opacity:(a?1:0),marginBottom:(a?b.ria.marginBottom:0),paddingTop:(a?b.ria.paddingTop:0),paddingBottom:(a?b.ria.paddingBottom:0)})}},addEventListeners:function(){this.navigation.addEvent("click",this.selectEvent.bind(this));window.addEventListener("keyup",this.keyboardEvent.bind(this),false);window.addEvent("resize",this.windowResizeEvent.bind(this));if(Browser.Platform.ios){window.addEvent("scroll",this.setNavPosition.bind(this))}},removeEventListeners:function(){this.navigation.removeEvents();this.removeScrollGetContentListener()},addScrollGetContentListener:function(){this.getContentBind=this.getContentWithinViewport.bind(this);window.addEvent("scroll",this.getContentBind)},removeScrollGetContentListener:function(){window.removeEvent("scroll",this.getContentBind);this.getContentBind=null},keyboardEvent:function(a){if(!a.ctrlKey&&!a.shiftKey&&!a.altKey&&!a.metaKey){this.filter(this.options.keyCodes[a.keyCode])}},selectEvent:function(b){b.preventDefault();var a=b.targetTouches?b.targetTouches[0].target.getAttribute("data-category"):b.target.getAttribute("data-category");if(a){this.filter(a)}a=null},filter:function(a){if(this.options.categories[a]){this.filterByCategory(a)}else{if(document.id(a)){this.goToArticle(document.id(a))}}},filterByCategory:function(a){if(this.options.category===a){return}this.setAlphaNavState();this.options.category=a;this.setCategoryNavState(a);this.articles.each(function(c,b){c.removeClass("active").removeClass("inactive");if(this.options.categories[a].indexOf(c.get("id"))===-1){this.navArticles[b].addClass("inactive");this.handleContent(c,false);this.filterFx(c,false,false)}else{this.filterFx(c,true,false);this.handleContent(c,false);this.navArticles[b].removeClass("inactive")}},this);this.scrollFx.toTop()},filterInAll:function(){this.articles.each(function(a){a.removeClass("active").removeClass("inactive");this.filterFx(a,true,true)},this)},setCategoryNavState:function(a){this.navCategories.each(function(b){b.removeClass("active").removeClass("inactive");if(b.id.test(a)){b.addClass("active")}},this)},setAlphaNavState:function(a){this.navArticles.each(function(b){if(a=="all"){b.removeClass("inactive").addClass("active")}else{if(b.id=="nav-alpha-"+a){b.removeClass("inactive").addClass("active")}else{b.removeClass("active").addClass("inactive")}}},this)},goToArticle:function(b){var a=RIA.Util.getViewport(),d=b.get("id"),c;this.articles.each(function(e){this.handleContent(e,false)},this);if(this.options.categories[this.options.category]&&this.options.categories[this.options.category].indexOf(d)===-1){this.filterInAll();this.setCategoryNavState();this.setAlphaNavState("all")}c=b.getPosition();this.scrollFx.options.duration=1000;if(c.y<a.scrollTop){this.scrollFx.options.duration+=this.getScrollVelocity(a.scrollTop,c.y)}else{this.scrollFx.options.duration+=this.getScrollVelocity(c.y,a.scrollTop)}this.scrollFx.toElement(d,"y");b=a=d=c=null},getScrollVelocity:function(d,c){return Math.floor(Math.PI*((d-c)/10));d=c=null},getContentWithinViewport:function(c){var a=RIA.Util.getViewport(),b;this.articles.each(function(d){b=d.getPosition();if((b.y>=a.scrollTop&&b.y<=(a.scrollTop+a.h))||(((b.y+d.ria.h)>=a.scrollTop)&&(b.y+d.ria.h)<=(a.scrollTop+a.h))){this.handleContent(d,true)}else{this.handleContent(d,false)}},this);a=b=null},setNavPosition:function(){Log.info("this.navOffsetTop: "+this.navOffsetTop);Log.info("document.body.scrollTop: "+document.body.scrollTop);Log.info(this.navFX);this.navFX.set("top",(this.navOffsetTop+document.body.scrollTop))},createFacebookLikeButton:function(c){if(!c.getElement("iframe")){var b=c.get("id"),a;a=new Element("iframe",{src:"http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fa-z-campaign.appspot.com/"+b+"&amp;layout=standard&amp;show_faces=true&amp;width=450&amp;action=like&amp;font&amp;colorscheme=light&amp;height=80&amp;ref=a-to-z-mcdonalds-"+b,scrolling:"no",frameborder:0,allowTransparency:"true",style:"border:none; overflow:hidden; width:450px; height:80px;"}).inject(c.getElement("nav"),"bottom")}},windowResizeEvent:function(){this.setNavigationPanelPosition();this.getContentWithinViewport()}});
